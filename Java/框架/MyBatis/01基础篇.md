...
<mapper namespace="departmentMapper">
 ...
 J   <select id="findAll" resultType="com.linkedbear.mybatis.entity.Department">
...
public class DepartmentTypeHandler implements TypeHandler<Department> {
    ...
    @Override
    Jpublic Department getResult(ResultSet rs, String columnName) throws SQLException {
...
```xml
  <resultMap id="userHandlerMap" type="com.example.mybatis.entity.User">
      ...
      <result property="birthday" column="birthday"/>
    	<!-- 需要自己定义返回结果 -->
     J <association property="department" javaType="com.example.mybatis.entity.Department"/>
  </resultMap>
...
显然，这也是一个接口，而MyBatis提供了一个默认的实现，`DefaultObjectFactory`，如果我们想要扩展该功能，可以继承它，然后重写create(Class<T> type)方法，比如现在我们想要实现一个功能，当查询出来的User的age为null时，就设置成0
